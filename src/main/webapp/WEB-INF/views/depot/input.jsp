...
<head>
    ...
    <%--<script type="text/javascript" src="/js/system/depot.js"></script>--%>
    <%@include file="/WEB-INF/views/common/common_msg.jsp"%>
</head>
<body>
<s:form name="editForm" action="depot_saveOrUpdate" namespace="/" id="editForm">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="depot.name" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">仓库地址</td>
                    <td class="ui_text_lt">
                        <s:textfield name="depot.location" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
