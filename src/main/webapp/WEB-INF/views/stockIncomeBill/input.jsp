        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select name="stockIncomeBill.depot.id" list="#depots" listKey="id" listValue="name"
                                  class="ui_select01"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:textfield name="stockIncomeBill.vdate" value="%{vdate}" class="ui_input_txt02 Wdate" onclick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
