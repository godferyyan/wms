...
<div class="ui_tb_h30">
    <div class="ui_flt" style="height: 30px; line-height: 30px;">
        ...
        条记录，当前第
        <span class="ui_txt_bold04"><s:property value="#result.currentPage"/>/<s:property
                value="#result.totalPage"/></span>
        页
    </div>
    <div class="ui_frt">
        ...
        <s:select list="{5,10,20,50}" name="qo.pageSize" class="ui_select02"></s:select>
