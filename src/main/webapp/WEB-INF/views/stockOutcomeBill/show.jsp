...
<body>
<s:form name="editForm" action="stockOutcomeBill_saveOrUpdate" namespace="/" id="editForm">
    <s:hidden name="stockOutcomeBill.id"/>
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">已审核的销售出库单的查看</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="stockOutcomeBill.depot.name" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户</td>
                    <td class="ui_text_lt">
                        <s:textfield name="stockOutcomeBill.client.name" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:textfield name="stockOutcomeBill.vdate" value="%{vdate}" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
