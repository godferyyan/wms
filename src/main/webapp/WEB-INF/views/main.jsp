...
<head>
	...
	<script type="text/javascript" src="/js/plugins/zTree/jquery.ztree.core-3.4.js"></script>
			...
			<div id="top_op">
				<ul>
					<li>
						...
						<span><s:property value="#session.EMPLOYEE_IN_SESSION.name" /></span>
					</li>
					<li>
		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
					<%--<li><a href="javascript:;" data-url="/department.action">部门管理</a></li>
					<li><a href="javascript:;" data-url="/employee.action">员工管理</a></li>
					<li><a href="javascript:;" data-url="/permission.action">权限管理</a></li>
					<li><a href="javascript:;" data-url="/role.action">角色管理</a></li>
					<li><a href="javascript:;" data-url="/systemMenu.action">系统菜单管理</a></li>--%>
				</ul>
		 	</div>
		 </div>
	</div>
