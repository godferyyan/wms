...
<body>
<s:form name="editForm" action="supplier_saveOrUpdate" namespace="/" id="editForm">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="supplier.name" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">联系电话</td>
                    <td class="ui_text_lt">
                        <s:textfield name="supplier.phone" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">地址</td>
                    <td class="ui_text_lt">
                        <s:textfield name="supplier.address" class="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
